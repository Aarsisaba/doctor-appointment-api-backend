...
// =======================
// Doctor Auth
// Doctor NEVER self-registers — there is no /doctor/register route.
// The Doctor account is created only by Admin via POST /api/admin/doctors.
// This route only authenticates against that existing record.
// =======================
